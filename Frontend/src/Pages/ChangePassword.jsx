...
const ChangePassword = () => {
    ...
    return (
        ...
        >
            ...
            <div className='p-8'>
                <h2 className='text-3xl font-bold mb-6 text-center bg-gradient-to-r from-green-400 to-emerald-500 text-transparent bg-clip-text'>Change Password</h2>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <motion.button
                        ...
                        type='submit'
                    >
                        {isLoading ? <Loader className='w-6 h-6 animate-spin text-center mx-auto' /> : "Change Password"}
                    </motion.button>
                </form>
            </div>
